...
TRAINING_DATASET_CONFIG="examples/training/sft/ltx_video/smoke-test/training.json"
VALIDATION_DATASET_FILE="examples/training/sft/ltx_video/smoke-test/validation.json"
...
miscellaneous_cmd=(
  ...
  --output_dir "./output/ltx-video/smoke-test"
  --init_timeout 600
  --nccl_timeout 600
  --report_to "wandb"
)
